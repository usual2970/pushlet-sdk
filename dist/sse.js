...
class SSE extends pushletClient_1.PushletClient {
    ...
    createEventSource(topic, onMessage) {
    ...
    handleReconnect(topic, onMessage) {
        ...
        console.log(`Attempting to reconnect to topic "${topic}" in ${delay}ms (attempt ${currentAttempts + 1}/${this.reconnectOptions.maxRetries})`);
